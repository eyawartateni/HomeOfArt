...
<div class="mb-3">
    ...
    <input type="int" class="form-control" id="idLivreur"  name="idLivreur" aria-describedby="idlHelp">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="email"  name="email"   pattern=".+@gmail.com|.+@HOA.tn" aria-describedby="emailHelp">
