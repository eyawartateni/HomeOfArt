      ...
      <?php
        ...
        <div class="product">
          ...
          <div class="product-footer">
            ...
            <br>
               <a href="detailedPub.php?libelle=<?php echo $reponse->libelle ;?>&descriptionP=<?php echo $reponse->descriptionP ?>&prix=<?php echo $reponse->prix ?>&imageP=<?php echo $reponse->imageP?>&quantite=<?php echo $reponse->quantite ?>&categorie=<?php echo $reponse->categorie ?>" class="pss" >details</a>  
