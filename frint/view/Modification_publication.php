                 ...
                 $id_client_publication=$_SESSION['id'];     
                  ...
                  if(isset ($_POST['submit']))
                  {
                    ...
                    if(!move_uploaded_file($tmp_file,$content_dir.$name_file)){
                      ...
                      $pubC->ModifierPublication_client($_GET['id_publication'],$titre,$description,$name_file,$id_client_publication);
                  ...
                  {   extract($_POST);
                      $vide="";
                      $pubC->ModifierPublication_client($_GET['id_publication'],$titre,$description, $vide,$id_client_publication);
                  }
