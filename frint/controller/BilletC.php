...
class BilletC
{
    ...
    {
    $sql = "SELECT * FROM billetterie where id_event=:id_evenement" ;
...
{
    $sql= "INSERT INTO billetterie(id_billet,id_evenement,nbre,prix) VALUES (:id_billet , :id_evenement , :nbre ,:prix)";
    $db= config::getConnexion();
    try
    {
$query=$db->prepare($sql);
$query->execute(
    ['id_billet'=> $userb->getIdb(),
