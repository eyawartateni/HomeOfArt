...
$comC->ModifierCommentaire($_GET['id_commentaire'],$messages);
...
<?php
			if (isset($_GET['id_commentaire'])){
				$comment= $comC->recupererCommentaire($_GET['id_commentaire']);
            }
...
<div class="center"><br><br><br>
 ...
 <form method="POST" action="">
      <input type="text" name=pseudo   value="<?php echo $comment['pseudo'];?>"  placeholder="Pseudo" required="" class="form form-control"disabled><br><br>
