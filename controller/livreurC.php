...
class LivreurC
{
    function ajouterLivreur($Livreur){
        $sql="INSERT INTO livreur (idLivreur,nomLivreur,prenomLivreur,adresse,email,salaire,tel) 
        VALUES (:idLivreur,:nomLivreur,:prenomLivreur,:adresse,:email,:salaire,:tel)";
    ...
    function modifierlivreur($idLivreur,$nomLivreur,$prenomLivreur,$adresse,$email,$salaire,$tel)
   {
    ...
    function rechercheLivreur($search_value)
    {
        $sql = "SELECT * FROM livraison where  idLivreur like '$search_value' or nomLivreur like '%$search_value%' or adresse like '%$search_value%' ";
